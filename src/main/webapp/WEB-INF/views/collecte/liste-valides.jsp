...
<div class="app-shell">
    ...
    <div class="page-heading">
        <div>
            <h1>Collecte : lots valides et payes</h1>
    ...
    <div class="stat-grid">
        <div class="stat-card stat-valide">
            ...
            <div class="stat-label">Quantite totale validee</div>
        </div>
        <div class="stat-card stat-valide">
            <div class="stat-value"><fmt:formatNumber value="${recetteTotale}" pattern="#,##0"/> Ar</div>
            <div class="stat-label">Recette totale validee</div>
        </div>
    </div>
                ...
                <table class="table-lots">
                    ...
                    <tbody>
                        ...
                        <c:if test="${empty lots}">
                            <tr><td colspan="6" class="vide">Aucun lot valide</td></tr>
                        </c:if>
                    </tbody>
                </table>
            </div>
