...
<body>
    ...
    <div class="page-heading">
        <div>
            ...
            <p>Enregistrer un nouveau lot acheté auprès d'un producteur</p>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/collectes/calculer" method="post" id="form-collecte">
                    ...
                    <div class="form-grid">
                        <div class="form-field">
                            <label>Quantité de Paddy (kg)</label>
                ...
                <!-- Import Excel -->
                <div class="form-grid" style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid #e5e7eb;">
                    <div class="form-field full">
                        <label>Importer depuis Excel</label>
                        <div class="flow-actions">
                            <input type="file" id="fichier-excel" accept=".xlsx">
                            <button type="button" class="btn btn-outline" onclick="importerExcel()">
                                📄 Remplir depuis Excel
                            </button>
                        </div>
